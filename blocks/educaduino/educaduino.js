//http://www.educaduino.fr
//http://www.eurosmart.fr
//http://eurosmart.biz/fr/174-educaduino
//Educaduino l'arduino 100% Français
//EUROSMART
//68 rue Jacquard
...
goog.provide('Blockly.Blocks.educaduino');

goog.require('Blockly.Blocks');

Blockly.Blocks['EDU_GAZMQ7_sensor'] = {
  init: function() {
    this.setColour("#ff0000");
	this.setHelpUrl(Blockly.Msg.EDU_INOUT_GAZMQ7_HELPURL);
    this.appendDummyInput()
        .appendField(Blockly.Msg.EDU_INOUT_GAZMQ7_TEXT)
        .appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blocks/educaduino/200px-GAZMQ7_sensor.jpg', Blockly.Arduino.imageSize, Blockly.Arduino.imageSize))
        .appendField(Blockly.Msg.EDU_INOUT_GAZMQ7_INPUT)
        .appendField(new Blockly.FieldTextInput('0',  Blockly.Arduino.pinAnalogValidator), 'PIN');
    this.setOutput(true, 'Number');
    this.setTooltip(Blockly.Msg.EDU_INOUT_GAZMQ7_TOOLTIP);
  }
};
